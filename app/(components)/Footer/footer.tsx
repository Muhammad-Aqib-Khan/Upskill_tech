          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="col-span-2 md:col-span-1">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <span className="text-2xl font-bold">Upskill</span>
              </div>
              <p className="text-gray-400">
                Transforming careers through cutting-edge education and professional development.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="/courses" className="hover:text-white transition-colors">Professional Courses</a></li>
                <li><a href="/certifications" className="hover:text-white transition-colors">Certification Programs</a></li>
                <li><a href="/workshops" className="hover:text-white transition-colors">Workshops</a></li>
                <li><a href="/corporate-training" className="hover:text-white transition-colors">Corporate Training</a></li>
              </ul>
            </div>
          ...
          <div className="container mx-auto px-6 py-4">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="text-gray-400 text-sm">
                © {currentYear} Upskill Institute. All rights reserved.
              </div>
